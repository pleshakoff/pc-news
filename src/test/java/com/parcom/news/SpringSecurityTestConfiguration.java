...
public class SpringSecurityTestConfiguration {
    ...
    public static final long ID_USER_ADMIN_GROUP = 1L;
    ...
    public UserDetailsService userDetailsService() {
        List<UserDetailsPC> testUsers = Arrays.asList(
                new UserDetailsPC("admin@parcom.com", "password",ID_USER_ADMIN, AuthorityUtils.createAuthorityList(UserUtils.ROLE_ADMIN), true,ID_USER_ADMIN_GROUP, 1L),
